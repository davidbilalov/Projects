...
public class TemperatureConverter extends JFrame {
    ...
    class Handler implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            {
                //Both are same.......................
                if(Objects.equals(x, "Celsius") && Objects.equals(y, "Celsius"))
                {
                    t2.setText(""+t1.getText());
                }
                else if(Objects.equals(x, "Fahrenheit") && Objects.equals(y, "Fahrenheit"))
                {
                    t2.setText(""+t1.getText());
                }
                else if(Objects.equals(x, "Kelvin") && Objects.equals(y, "Kelvin"))
                {
                    t2.setText(""+t1.getText());
                }
                else if(Objects.equals(x, "Rankine") && Objects.equals(y, "Rankine"))
                {
                    t2.setText(""+t1.getText());
                }
                else if(Objects.equals(x, "Reaumur") && Objects.equals(y, "Reaumur"))
                {
                    t2.setText(""+t1.getText());
                }

                //Celsius to others.........................
                else if(Objects.equals(x, "Celsius") && Objects.equals(y, "Fahrenheit"))
                {
                    String s = t1.getText();
                ...
                else if(Objects.equals(x, "Celsius") && Objects.equals(y, "Kelvin"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Celsius") && Objects.equals(y, "Rankine"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Celsius") && Objects.equals(y, "Reaumur"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                    float b = (float)(a * 0.8);
                ...
                else if(Objects.equals(x, "Fahrenheit") && Objects.equals(y, "Celsius"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                    float b = (a - 32) * 5/9;
                ...
                else if(Objects.equals(x, "Fahrenheit") && Objects.equals(y, "Kelvin"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Fahrenheit") && Objects.equals(y, "Rankine"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Fahrenheit") && Objects.equals(y, "Reaumur"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                //Kelvin to others.........................
                else if(Objects.equals(x, "Kelvin") && Objects.equals(y, "Celsius"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                    float b = (float)(a - 273.15);
                ...
                else if(Objects.equals(x, "Kelvin") && Objects.equals(y, "Fahrenheit"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Kelvin") && Objects.equals(y, "Rankine"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                    float b = a * 9/5;
                ...
                else if(Objects.equals(x, "Kelvin") && Objects.equals(y, "Reaumur"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                //Rankine to others............................
                else if(Objects.equals(x, "Rankine") && Objects.equals(y, "Celsius"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Rankine") && Objects.equals(y, "Fahrenheit"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                    float b = (float)(a - 459.67);
                ...
                else if(Objects.equals(x, "Rankine") && Objects.equals(y, "Kelvin"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                    float b = (float)(a/1.8);
                ...
                else if(Objects.equals(x, "Rankine") && Objects.equals(y, "Reaumur"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                //Reaumur to others........................
                else if(Objects.equals(x, "Reaumur") && Objects.equals(y, "Celsius"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Reaumur") && Objects.equals(y, "Fahrenheit"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Reaumur") && Objects.equals(y, "Kelvin"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
                ...
                else if(Objects.equals(x, "Reaumur") && Objects.equals(y, "Rankine"))
                {
                    String s = t1.getText();
                    float a = Float.parseFloat(s);
    ...
    {
        TemperatureConverter jf = new TemperatureConverter();
        jf.setComp();
        jf.setSize(400,500);
        jf.setVisible(true);
